...
def gui(page: ft.Page):
    ...
    market = gui_cards.CardMarket(page, game)
    game_bank = gui_game_bank.GameBank(game)
    player_board = gui_player_board.PlayerBank(page, game.get_current_player())
    ...
    test_player_bank_values(game, player_board)
    test_player_new_reserved(game, market, player_reserved)
