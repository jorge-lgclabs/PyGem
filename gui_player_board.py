...
class PlayerBank:
    ...
    def create_bank_and_dado_grid(self):
        ...
        for obj_tuple in self.text_obj_tuples:
            ...
            bank_dado_container = ft.Container(border_radius=PLAYER_BANK_ROUNDING_RADIUS, alignment=ft.alignment.Alignment.CENTER, height=self.size*1.5,
            ...
            gem_icon_container = ft.Container(border_radius=PLAYER_BANK_ROUNDING_RADIUS, alignment=ft.alignment.Alignment.CENTER, height=self.size*.75,
        ...
        gold_value_text_container =  ft.Container(content=self.gold_text_obj.gui_obj, width=self.size, height=self.size,
                                          alignment=ft.alignment.Alignment.CENTER)
        gold_value_container = ft.Container(border_radius=PLAYER_BANK_ROUNDING_RADIUS, alignment=ft.alignment.Alignment.CENTER, height=self.size*1.5,
        ...
        bank_and_dado_row_obj = ft.Row(controls=bank_and_dado_row, vertical_alignment=ft.CrossAxisAlignment.CENTER, alignment=ft.MainAxisAlignment.CENTER)
        gem_bank_row_obj = ft.Row(controls=gem_icon_row, vertical_alignment=ft.CrossAxisAlignment.CENTER, alignment=ft.MainAxisAlignment.CENTER)
